...
int main(int argc, char* argv[]) {
	...
	CharacterRecognition::MultiLayerPerceptron *mnistMlp = new CharacterRecognition::MultiLayerPerceptron(image_size + 1, 2, hiddenDimensionsMnist, number_of_classes, number_of_images_considered);
	...
	CharacterRecognition::MultiLayerPerceptron *mlpAlpha = new CharacterRecognition::MultiLayerPerceptron(numberOfFeaturesAlpha, 1, hiddenDimensionsAlpha, numberOfClassesAlpha, numberOfInstancesAlpha);
	delete(predicted);
